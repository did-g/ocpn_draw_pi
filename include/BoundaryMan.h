...
class BoundaryMan : public PathMan
{
    public:
        ...
        wxString    FindLineCrossingBoundary( bool useCache, double StartLat, double StartLon, double EndLat, double EndLon, double *CrossingLat, double *CrossingLon, double *Crossingdist,  
